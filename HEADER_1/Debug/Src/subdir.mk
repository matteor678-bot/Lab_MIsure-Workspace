...
Src/%.o Src/%.su Src/%.cyclo: ../Src/%.c Src/subdir.mk
	arm-none-eabi-gcc "$<" -mcpu=cortex-m4 -std=gnu11 -g3 -DDEBUG -DSTM32F303VCTx -DSTM32 -DSTM32F3 -DSTM32F3DISCOVERY -c -I"/Users/matteorusso/STM32CubeIDE/workspace_2.2.0/workspace/HEADER_1/Drivers/CMSIS/Include" -I"/Users/matteorusso/STM32CubeIDE/workspace_2.2.0/workspace/HEADER_1/Drivers/CMSIS/Device/ST/STM32F3xx/Include" -I../Inc -O0 -ffunction-sections -fdata-sections -Wall -fstack-usage -fcyclomatic-complexity -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" --specs=nano.specs -mfpu=fpv4-sp-d16 -mfloat-abi=hard -mthumb -o "$@"
